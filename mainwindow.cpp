...
void MainWindow::on_actionOpen_triggered() {
  ...
  this->tiltShift = TiltShift(filename.toLocal8Bit().toStdString());
...
void MainWindow::on_actionAbout_triggered() {
  QMessageBox::information(this, "Informacje",
                           "Program napisany w ramach projektu z przedmiotu "
...
void MainWindow::on_spinBoxBlurUp_valueChanged(int value) {
  if (value % 2 == 1) {
    ...
    QMessageBox::warning(this, "Błąd", "Musisz podać nieparzysty wymiar.");
}
...
void MainWindow::on_spinBoxBlurDown_valueChanged(int value) {
  if (value % 2 == 1) {
    this->tiltShift.downSize = value;
    this->tiltShift.gaussianBlur();
  } else
    QMessageBox::warning(this, "Błąd", "Musisz podać nieparzysty wymiar.");
}
